    ...
    if( product.countered === 0 ){
      ...
      if(product.id == 'GR1'){
        if(product.countered >= 2 && !(product.countered  % 2 == 0)){
          product.offer=(((product.countered/2)*product.price + (product.price*0.5))).toFixed(2);
        }else if(product.countered  % 2 == 0){
          product.offer=((product.countered/2)*product.price).toFixed(2);
          console.log('Se ha aplicado una Oferta especial a tu producto',product.name , '2 x 1' )
        }else{
          product.offer=(product.countered*product.price).toFixed(2);
        }
      }else if(product.id == 'SR1'){
        if(product.countered >= 3){
          product.offer=(product.countered*4.5).toFixed(2);
        ...
        if( product.countered >= 3){
          product.offer=(product.countered*(product.price*0.66)).toFixed(2);
